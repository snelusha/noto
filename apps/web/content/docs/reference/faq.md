...
### "no previous commit message found"

Make sure you've run `noto` at least once to generate a commit message. The `noto prev` command retrieves the last message generated by `noto`.
